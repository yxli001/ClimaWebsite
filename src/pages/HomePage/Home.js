  ...
  return (
    <div className={styles.homePageContainer}>
      ...
      <div className={styles.contentContainer}>
        <div className={`${styles.left} animate__animated animate__fadeInLeft`}>
          <div className={styles.content}>
            ...
            <div className={styles.downloadImages}>
              <a href="https://apps.apple.com/us/app/clima-save-the-environment/id6444138849">
                <img
                  src={appStore}
              ...
              <a href="https://play.google.com/store/apps/details?id=com.clima.mobile.app">
                <img
                  src={googlePlay}
                  alt="Download on app store"
                  className={styles.download}
        ...
        >
          <img src={homePageSS} alt="App home page" className={styles.phone} />
        </div>
      </div>
      ...
      <a
        ...
        href="#benefits"
      >
        <img className={styles.downArrow} src={arrow} alt="Go to Features" />
      </a>
    </div>
  );
};
